...
import {
  ...
  ChevronRight, Globe, Users, Zap, AlertCircle, Scale, Search, Navigation2
} from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: '/heatmap', label: 'Risk Heat Map', icon: Globe },
  { href: '/trade', label: 'Trade Economics', icon: BarChart3 },
  { href: '/trade/corridors', label: 'Bilateral Corridors', icon: Navigation2 },
  { href: '/rules', label: 'Rules & Simulator', icon: BookOpen },
  { href: '/chat', label: 'AI Copilot & Calc', icon: MessageSquare },
  { href: '/reports', label: 'Reports & Ledger', icon: FileText },
