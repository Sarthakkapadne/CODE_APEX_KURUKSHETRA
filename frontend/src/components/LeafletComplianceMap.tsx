...
export default function LeafletComplianceMap({
  ...
  useEffect(() => {
    ...
    async function initMap() {
      ...
      // MapTiler Dataviz Dark Layer (Powered by MapTiler API Key)
      const maptilerApiKey = process.env.NEXT_PUBLIC_MAPTILER_API_KEY || 'CTTf1GnjFmqpYI0cPqIC';
      L.tileLayer(`https://api.maptiler.com/maps/dataviz-dark/256/{z}/{x}/{y}.png?key=${maptilerApiKey}`, {
