...
type TileProvider = 'cartodb_dark' | 'maptiler_streets' | 'maptiler_dark' | 'osm_standard' | 'stadia_smooth' | 'thunderforest_transport' | 'custom';
...
const TILE_PROVIDERS: Record<TileProvider, TileProviderConfig> = {
  cartodb_dark: {
    name: 'CartoDB Dark Matter (High-Speed Dark — Free / No Key)',
...
export default function LeafletTradeMap({
  ...
  const [tileProvider, setTileProvider] = useState<TileProvider>('cartodb_dark');
