import { PresetListing } from './types';

export const CASE_PRESETS: PresetListing[] = [
  {
    id: "preset-ayurvedic-cream",
    title: "AyurVeda Miracle Joint & Muscle Healing Cream - Cures Arthritis Pain Permanently",
    description: `• 100% NATURAL PERMANENT RELIEF: Clinically proven herbal formulation cures arthritis and completely eliminates chronic joint inflammation.
...
• DIRECTIONS: Apply generously to affected area twice daily. Suitable for all adults.`,
  ...
  },
  {
    ...
    description: `• MULTI-DIRECTIONAL SWIVEL WHEELS: Smooth gliding rolling wheels designed for infant developmental mobility and walking practice on flat floors.
...
• SAFETY TESTED: ASTM F977 safety certified with stair friction grip pads.`,
  ...
  },
  {
    ...
    description: `• ANTIBACTERIAL SURFACE TECHNOLOGY: Built-in antibacterial protection kills 99.9% of bacteria and household germs on contact.
...
• PRE-SEASONED: Finished with food-grade mineral oil for water-repellent durability.`,
  ...
  },
  {
    ...
    description: `• ANTI-ROLL SIDE BUMPERS: Ergonomic curved foam bolsters prevent infant from rolling over onto stomach during unmonitored crib sleep.
...
• PEDIATRICIAN DESIGNED: Engineered for infants from 0 to 6 months in cribs, bassinets, and co-sleeping beds.`,
  ...
  },
  {
    ...
    description: `• 3-IN-1 THERMAL MASSAGE: 42°C soothing heat massage combined with high-frequency sonic vibration to reduce dark circles and puffiness.
