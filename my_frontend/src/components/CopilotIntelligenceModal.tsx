...
export default function CopilotIntelligenceModal({ isOpen, onClose }: CopilotIntelligenceModalProps) {
  ...
  const [history, setHistory] = useState<any[]>([
    ...
    {
      query: 'What is the distribution of inspection verdicts?',
      chart_type: 'pie',
      x_axis: 'overall_verdict',
      y_axis: 'count',
      summary: 'Overall product inspection verdicts showing pass vs escalation rates.',
      sql: "SELECT overall_verdict, COUNT(id) as count FROM inspections GROUP BY overall_verdict",
      data: [
        { overall_verdict: 'COMPLIANT', count: 12 },
        { overall_verdict: 'REMEDIATION_REQUIRED', count: 5 },
        { overall_verdict: 'ESCALATION_REQUIRED', count: 3 },
        { overall_verdict: 'IMPORT_PROHIBITED', count: 1 },
      ]
    }
  ]);
